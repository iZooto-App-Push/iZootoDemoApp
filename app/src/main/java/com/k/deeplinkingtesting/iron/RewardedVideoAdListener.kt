...
class RewardedVideoAdListener(private val listener: ActivityListener) : LevelPlayRewardedVideoListener {

    private val TAG = RewardedVideoAdListener::class.java.name
    ...
    override fun onAdAvailable(adInfo: AdInfo) {
        ...
        listener.setEnablementForButton(ButtonIdentifiers.SHOW_REWARDED_VIDEO_BUTTON_IDENTIFIER, true)
    }
    ...
    override fun onAdUnavailable() {
        logCallbackName(TAG, "")
        listener.setEnablementForButton(ButtonIdentifiers.SHOW_REWARDED_VIDEO_BUTTON_IDENTIFIER, false)
    }
