...
class BannerAdListener(private val listener: ActivityListener) :
    ...
    override fun onAdLoaded(adInfo: LevelPlayAdInfo) {
        ...
        listener.setEnablementForButton(ButtonIdentifiers.LOAD_BANNER_BUTTON_IDENTIFIER, false)
        listener.setEnablementForButton(ButtonIdentifiers.DESTROY_BANNER_BUTTON_IDENTIFIER, true)
    }
