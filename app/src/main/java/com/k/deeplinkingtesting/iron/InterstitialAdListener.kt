...
class InterstitialAdListener(private val listener: ActivityListener) :
    ...
    override fun onAdLoaded(adInfo: LevelPlayAdInfo) {
        ...
        listener.setEnablementForButton(ButtonIdentifiers.SHOW_INTERSTITIAL_BUTTON_IDENTIFIER, true)
    }
    ...
    override fun onAdLoadFailed(error: LevelPlayAdError) {
        ...
        listener.setEnablementForButton(ButtonIdentifiers.SHOW_INTERSTITIAL_BUTTON_IDENTIFIER, false)
    }
