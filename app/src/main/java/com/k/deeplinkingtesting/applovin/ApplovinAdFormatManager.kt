...
class ApplovinAdFormatManager(private val context: Activity) {
    ...
    fun loadBannerAd(
        ...
        try {
            maxAdViewBanner =
                MaxAdView(context.resources.getString(R.string.aap_lovin_banner_ad_unit), context)
            ...
            val heightDp = context.resources.getDimensionPixelSize(R.dimen.banner_height)

            maxAdViewBanner.setLayoutParams(
