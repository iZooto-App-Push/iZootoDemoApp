...
class AppInterstitial {
    private val tag = "AppInterstitial"
    ...
    fun callback(context: Activity, listener: OnAdsCallbackListener) {
        ...
        mAdManagerInterstitialAd?.onPaidEventListener = OnPaidEventListener {
