...
public final class SfwidgetArticleHeaderBinding implements ViewBinding {
  @NonNull
  ...
  private SfwidgetArticleHeaderBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView box3SmallTv, @NonNull TextView dateBigTv, @NonNull TextView dateSmallTv) {
  ...
  @NonNull
  public static SfwidgetArticleHeaderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SfwidgetArticleHeaderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.sfwidget_article_header, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SfwidgetArticleHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SfwidgetArticleHeaderBinding((RelativeLayout) rootView, articleHeaderTextLayout,
          articleHeadlineTv, articleImage, box1BigTv, box1SmallTv, box2BigTv, box2SmallTv,
          box3BigTv, box3SmallTv, dateBigTv, dateSmallTv);
    }
