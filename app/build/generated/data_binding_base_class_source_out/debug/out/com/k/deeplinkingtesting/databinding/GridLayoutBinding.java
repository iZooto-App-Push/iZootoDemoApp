...
public final class GridLayoutBinding implements ViewBinding {
  ...
  private GridLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout mainLayout,
      @NonNull ScrollView parentLayout, @NonNull RecyclerView recyclerView) {
  ...
  public static GridLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ScrollView parentLayout = ViewBindings.findChildViewById(rootView, id);
      ...
      return new GridLayoutBinding((ConstraintLayout) rootView, mainLayout, parentLayout,
          recyclerView);
    }
