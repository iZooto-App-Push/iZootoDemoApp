...
public final class NativeAdLayoutBinding implements ViewBinding {
  ...
  private NativeAdLayoutBinding(@NonNull NativeAdView rootView, @NonNull ImageView adAppIcon,
  ...
  public static NativeAdLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdLayoutBinding((NativeAdView) rootView, adAppIcon, adBody, adCallToAction,
          adHeadline, nativeAdView);
    }
